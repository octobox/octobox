module ApplicationHelper
  ...
  def flash_messages
    ...
    concat(content_tag(:div, class: "flex-header header-flash-messages", role: "alert") do
  ...
  def repo_scope_modal
    content_tag :span, octicon('shield'), class: 'btn btn-sm btn-link repo-scope d-inline-block', title: 'Requires repo scope', data: {"bs-toggle":'modal', target:'#repo-scope'} unless Octobox.fetch_subject? || Octobox.personal_access_tokens_enabled?
  end
